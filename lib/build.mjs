...
.tier-typed{font:800 34px/1.3 "Vazirmatn",sans-serif;text-align:center;
  direction:rtl;flex:none}
.tier-part{color:#fff}
.tier-part-cursor{font-weight:400;margin-right:.05em;opacity:0}
.tier-part-bad{color:#ff3b30;font-size:34px;font-weight:900;display:inline-block}
.tier-part-good{color:#00ff88;font-size:38px;font-weight:900;display:inline-block}
.tier-part-gold{font-size:32px;font-weight:900;display:inline-block;
  background:linear-gradient(90deg,#ffd700,#ffb700);-webkit-background-clip:text;
  background-clip:text;color:transparent;filter:drop-shadow(0 0 14px rgba(255,183,0,.55))}
...
// "ChatGPT تمام شد!" shakes once it's fully typed.
tl.to("#s1 .tier-part-bad",{x:-6,duration:.05,ease:"none"},1.2)
  .to("#s1 .tier-part-bad",{x:6,duration:.06,ease:"none"})
  .to("#s1 .tier-part-bad",{x:-4,duration:.06,ease:"none"})
  .to("#s1 .tier-part-bad",{x:3,duration:.06,ease:"none"})
  .to("#s1 .tier-part-bad",{x:0,duration:.07,ease:"none"});
// "N ابزاری که جایش را گرفت" pops to its emphasised scale once typed.
tl.fromTo("#s1 .tier-part-good",{scale:1},{scale:1.3,duration:.35,ease:"back.out(2.4)"},1.9);
tl.fromTo("#s1 .tier-part-tail",{opacity:0},{opacity:1,duration:.3,ease:"power2.out"},2.9);
