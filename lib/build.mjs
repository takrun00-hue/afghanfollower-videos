...
// tier-list hook: the BAD/GOOD/GREAT columns drop in one after another
tl.fromTo("#s1 .tier-col",{y:-60,opacity:0},{y:0,opacity:1,duration:.4,stagger:.14,ease:"back.out(1.8)"},.7);
ken("#s1c",0,${HOOK});
