...
.tier-typed{font:700 36px/1.4 "Vazirmatn",sans-serif;text-align:center;
  direction:rtl;flex:none;color:#fff}
.tier-part{color:#fff}
.tier-part-cursor{font-weight:400;margin-right:.05em;opacity:0}
.tier-part-plain{color:#fff;font-size:36px;font-weight:700;display:inline-block}
