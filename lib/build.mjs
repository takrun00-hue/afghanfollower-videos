...
.tier-hook .bg{background:radial-gradient(700px 500px at 50% 0%,#F0C68A 0%,#8a5a3a 45%,#1a1008 100%)}
...
/* Pale blue-white, not the warm yellow-tan the canvas fix wrongly landed
   here, and not the original dark purple-black either — a soft off-white
   with a blue lean, in between full blue and full white. */
.iphone15-screen{background:radial-gradient(600px at 50% 0%,#F4F9FF 0%,#DCEBFA 55%,#C7DEF2 100%);
