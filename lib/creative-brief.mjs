...
export function creativeBriefFor(pack, { date = new Date(), recent = [] } = {}) {
  ...
  return {
    ...
    analysis: {
      audience: "سازندگان محتوای فارسی‌زبان که دنبال درآمد، رشد یا ایدهٔ تازه‌اند",
    ...
    goal: "توضیح یک اقدام قابل‌انجام بدون وعدهٔ نتیجه",
    hook: { text: hook, holdLine: "تا آخر ببین؛ گام آخر مهم است." },
    visualIdentity: {
