...
// The German-lesson series (pack.kind === "german-lesson") reuses platform
// "news" for its unbranded layout, but NEWS_NUDGES's "خبر"/"جزئیات خبر"
// wording is about a news story and reads as nonsense over a vocabulary
// lesson (owner report 2026-09-10: hook read as "خالی و بی‌معنی"). Its own
// set promises what a lesson actually withholds: the pronunciation and the
// rest of the words.
const LESSON_NUDGES = [
  "تلفظ درستش را تا آخر بشنو",
  "بقیهٔ کلمه‌ها را از دست نده",
  "تا آخر ببین، جمله‌اش را هم یاد می‌گیری",
  "نکتهٔ گرامری‌اش در ادامه است",
];
...
export function retentionLineFor(pack) {
  ...
  if (pack.kind === "german-lesson") return LESSON_NUDGES[hash(key) % LESSON_NUDGES.length];
