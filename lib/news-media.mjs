...
// A licence that permits reuse. Anything else — "fair use", "non-free",
// agency-owned — is skipped, whatever its search rank.
const REUSABLE = /^(cc[ -]?by(?![a-z])|cc[ -]?by[ -]?sa|cc0|public domain|pd(-|\b)|no restrictions)/i;
// Attribution is required for everything except these.
...
const QUERIES = {
  ...
  timeline: ["video editing timeline computer", "editing software screen"],
