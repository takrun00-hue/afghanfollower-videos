  ...
  news: [
    {
      ...
      benefit: { key: "seen", fa: "" },
      title: "رأی دادگاه قانون اساسی آلمان — افغان فالورز",
      hook: {
      ...
      tgTitle:
        "⚖️ دادگاه قانون اساسی آلمان: لغو یک‌جای تعهدات پذیرش افغان‌ها خلاف قانون اساسی بود\n\n" +
        "منبع: Bundesverfassungsgericht — رأی جولای ۲۰۲۶\n" +
        "⚠️ این خبر است، نه مشاورهٔ حقوقی. برای پروندهٔ خودت با وکیل مشورت کن.\n\n" +
        "#افغانستان #آلمان #مهاجرت #افغان_فالورز",
    },
    {
      ...
      benefit: { key: "seen", fa: "" },
      title: "مسیر حقوقی جواب داده — افغان فالورز",
      hook: {
      ...
      tgTitle:
        "⚖️ مسیر حقوقی جواب داده: ۲۰۰+ پروندهٔ برنده و ۱۰۱۸ نفر رسیده به آلمان\n\n" +
