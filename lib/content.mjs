...
const INK = {
  ...
  news:      { pair: ["#1F2937", "#B45309"], paper: "#F2F0EC", tint: "rgba(31,41,55,.08)" },
};
...
OUTRO.news = { tag: 'برای خبرهای مهاجرت،<br/>ما را دنبال کن.', follow: "دنبال کنید +" };
KICKERS.news = "خبر";
THEMES.news = THEMES.general;
