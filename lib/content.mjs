...
//
// So option 1 is what ships, now that the breath/digit/semicolon fixes sit
// underneath it — those were real, independent faults regardless of which
// way this specific question resolves. Whether it reads acceptably is for
// the user to say; nothing here can confirm it without the ability to listen
// (Whisper is blocked on this machine — see spokenForm's old comment,
// removed with it).
