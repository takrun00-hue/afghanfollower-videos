...
export const FEATURES = {
  instagram: [
    ...
    },
    {
      ...
      hook: { ask: "با این قابلیت رایگان، کامنت‌های بد را خودکار پاک کن", l1: "کامنت‌های بد را", l2: "خودکار پنهان کن" },
    ...
    },
    {
      ...
      hook: { ask: "بدون بلد بودن تدوین، ریلز حرفه‌ای بساز و ویو بگیر", l1: "ریلز حرفه‌ای", l2: "بدون تدوین" },
  ...
  tiktok: [
    ...
    },
    {
      ...
      hook: { ask: "با این قابلیت رایگان تیک‌تاک، بگذار مخاطب برایت سوژه بسازد", l1: "بگذار مخاطب", l2: "برایت سوژه بسازد" },
    ...
    },
    {
      ...
      hook: { ask: "بدون دوربین و بدون تدوین، محتوای پربازدید بساز", l1: "بدون دوربین", l2: "محتوا بساز" },
  ...
  tools: [
    {
      ...
      hook: { ask: "با این اپ رایگان، عکس تار قدیمی‌ات را واضح کن", l1: "عکس کم‌کیفیت را", l2: "واضح کن" },
    ...
    },
    {
      ...
      hook: { ask: "با این اپ رایگان، پس‌زمینهٔ عکس را در چند ثانیه پاک کن", l1: "پس‌زمینه را", l2: "در چند ثانیه پاک کن" },
