  ...
  tools: [
    {
      ...
      steps: [
        { icon: "globe", text: "برنامهٔ رایگان Upscayl را نصب کن" , ui: { screen: "tool", url: "upscayl.org", cta: "دانلود رایگان" } },
    ...
    },
    {
      ...
      steps: [
        { icon: "globe", text: "سایت remove.bg را باز کن" , ui: { screen: "tool", url: "remove.bg", cta: "باز کردن سایت" } },
...
export function featureFor(cat, dayIndex) {
  // base set + the extra pack, so the daily rotation runs for weeks
  const list = [...(FEATURES[cat] || []), ...((EXTRA && EXTRA[cat]) || [])];
