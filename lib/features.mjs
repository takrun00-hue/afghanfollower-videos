  ...
  instagram: [
    {
      ...
      hook: { ask: "با این قابلیت اینستاگرام، پستت را دو برابر بیشتر دیده شو", l1: "پستت را روی", l2: "دو پیج نشان بده" },
    ...
    },
    {
      ...
      hook: { ask: "با این قابلیت رایگان، پیجت را از توهین و اسپم امن نگه دار", l1: "کامنت‌های بد را", l2: "خودکار پنهان کن" },
    ...
    },
    {
      ...
      hook: { ask: "با این قابلیت اینستاگرام، در پنج دقیقه یک ریلز آماده کن", l1: "ریلز حرفه‌ای", l2: "بدون تدوین" },
  ...
  tiktok: [
    {
      ...
      hook: { ask: "با این ترفند، از هر کامنت یک ویدیوی پربازدید بساز", l1: "به کامنت", l2: "با ویدیو جواب بده" },
    ...
    },
    {
      ...
      hook: { ask: "با این قابلیت رایگان تیک‌تاک، دیگر برای ویدیوی بعدی سوژه کم نیاور", l1: "بگذار مخاطب", l2: "برایت سوژه بسازد" },
    ...
    },
    {
      ...
      hook: { ask: "بدون دوربین و بدون تدوین، محتوای پربازدید بساز", l1: "فقط چند عکس", l2: "و یک آهنگ" },
  ...
  tools: [
    {
      ...
      hook: { ask: "با این اپ رایگان، عکس‌های قدیمی‌ات را دوباره قابل انتشار کن", l1: "عکس کم‌کیفیت را", l2: "واضح کن" },
    ...
    },
    {
      ...
      hook: { ask: "با این اپ رایگان، عکس محصول و پروفایلت را حرفه‌ای کن", l1: "پس‌زمینه را", l2: "در چند ثانیه پاک کن" },
    ...
    },
    {
      ...
      hook: { ask: "با این اپ رایگان زیرنویس بگذار — یک‌سوم مردم بی‌صدا می‌بینند", l1: "زیرنویس ویدیو را", l2: "خودکار بساز" },
