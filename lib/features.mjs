  ...
  instagram: [
    {
      ...
      hook: { ask: "با این قابلیت اینستاگرام، پستت را روی دو پیج ببر و دو برابر ویو بگیر", l1: "پستت را روی", l2: "دو پیج نشان بده" },
    ...
    },
    {
      ...
      tgTitle: "🎬 ریلز حرفه‌ای بدون تدوین با Reels Templates\n\n#instagram #reels #contentcreator #AfghanFollowers #viral",
    },
  ],
  tiktok: [
    {
    ...
    },
    {
      ...
      hook: { ask: "با این قابلیت تیک‌تاک، سوژهٔ ویدیوی بعدی‌ات را فالوورهایت بسازند", l1: "بگذار مخاطب", l2: "برایت سوژه بسازد" },
...
export function featureById(id) {
  ...
  for (const cat of Object.keys({ ...DEMAND, ...Y2026, ...FRESH, ...FEATURES, ...EXTRA })) {
