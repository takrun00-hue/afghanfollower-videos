...
export const FEATURES = {
  ...
  tools: [
    ...
    },
    {
      ...
      hook: { ask: "بک‌گراند عکست را در چند ثانیه پاک کن — رایگان و بدون نصب", l1: "پس‌زمینه را", l2: "در چند ثانیه پاک کن" },
    ...
    },
    {
      ...
      hook: { ask: "یک‌سوم مردم بی‌صدا می‌بینند؛ زیرنویس بگذار — رایگان", l1: "زیرنویس ویدیو را", l2: "خودکار بساز" },
