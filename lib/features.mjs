...
export const FEATURES = {
  instagram: [
    {
      id: "collab",
      benefit: { key: "viral", fa: "پستت را روی دو پیج ببر تا دو برابر دیده شود" },
      name: "Collab",
    ...
    {
      id: "hidden-words",
      benefit: { key: "seen", fa: "کامنت‌های بد را پاک کن تا پیجت سالم بماند" },
      name: "Hidden Words",
  ...
  tiktok: [
    {
      id: "reply-video",
      benefit: { key: "viral", fa: "از هر کامنت یک ویدیوی تازه و پربازدید بساز" },
    ...
    {
      id: "qa",
      benefit: { key: "viral", fa: "بگذار مخاطب برایت سوژهٔ وایرال بسازد" },
      name: "Q&A",
    ...
    {
      id: "photo-mode",
      benefit: { key: "viral", fa: "بدون دوربین، محتوای پربازدید بساز" },
      name: "Photo Mode",
  ...
  tools: [
    {
      id: "upscayl",
      benefit: { key: "seen", fa: "عکس تار قدیمی را واضح و قابل‌انتشار کن" },
      name: "Upscayl",
    ...
    {
      id: "removebg",
      benefit: { key: "seen", fa: "پس‌زمینه را پاک کن و کاور تمیز بساز" },
      name: "remove.bg",
    ...
    {
      id: "capcut-captions",
      benefit: { key: "seen", fa: "زیرنویس بگذار؛ بیشتر مردم بی‌صدا می‌بینند" },
      name: "CapCut",
