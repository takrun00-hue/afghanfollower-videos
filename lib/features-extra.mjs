  ...
  instagram: [
    {
      ...
      hook: { ask: "با این قابلیت، اولین چیزی که غریبه می‌بیند را خودت انتخاب کن", l1: "بهترین پست‌هایت را", l2: "بالای پیج نگه دار" },
    ...
    },
    {
      ...
      hook: { ask: "با این قابلیت رایگان، برای مخاطب خاصت محتوای ویژه بگذار", l1: "برای مخاطب وفادارت", l2: "محتوای ویژه بگذار" },
    ...
    },
    {
      ...
      hook: { ask: "با این استیکر رایگان، مخاطب را وارد محتوایت کن و بیشتر دیده شو", l1: "یک زنجیرهٔ استوری", l2: "راه بینداز" },
  ...
  tiktok: [
    {
      ...
      hook: { ask: "با این قابلیت، کاری کن بیننده پشت‌سرهم ویدیوهایت را ببیند", l1: "کاری کن بیننده", l2: "پشت‌سرهم تماشا کند" },
    ...
    },
    {
      ...
      hook: { ask: "با این قابلیت رایگان، هر تصویری را پشت خودت بگذار", l1: "عکس یا صفحه را", l2: "پشت خودت بگذار" },
    ...
    },
    {
      ...
      hook: { ask: "بدون ضبط صدا، ویدیوی گویا بساز و بیشتر دیده شو", l1: "بدون ضبط صدا", l2: "روایت بساز" },
  ...
  tools: [
    {
      ...
      hook: { ask: "با این اپ رایگان، کاوری بساز که کلیک بگیرد", l1: "کاور حرفه‌ای", l2: "بدون طراح" },
    ...
    },
    {
      ...
      hook: { ask: "با این اپ رایگان، تصویری بساز که متنش خوانا باشد", l1: "تصویری بساز", l2: "که متنش خوانا باشد" },
    ...
    },
    {
      ...
      hook: { ask: "با این اپ رایگان، پست‌های یک هفته را یک شب آماده کن", l1: "پست‌های یک هفته را", l2: "یک‌جا آماده کن" },
