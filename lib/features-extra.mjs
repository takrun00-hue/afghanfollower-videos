...
export const EXTRA = {
  instagram: [
    ...
    {
      id: "add-yours",
      benefit: { key: "viral", fa: "با یک استیکر، مخاطب را وارد محتوایت کن" },
  ...
  tiktok: [
    {
      id: "playlists",
      benefit: { key: "seen", fa: "کاری کن بیننده پشت‌سرهم ویدیوهایت را ببیند" },
    ...
    {
      id: "green-screen",
      benefit: { key: "viral", fa: "با پس‌زمینهٔ دلخواه، ویدیوهایت را حرفه‌ای کن" },
  ...
  tools: [
    {
      id: "canva-cover",
      benefit: { key: "seen", fa: "کاوری بساز که کلیک بگیرد" },
    ...
    {
      id: "ideogram-text",
      benefit: { key: "seen", fa: "تصویری بساز که متنش خوانا باشد" },
    ...
    {
      id: "meta-schedule",
      benefit: { key: "seen", fa: "پست‌های یک هفته را یک شب آماده کن" },
