...
export const EXTRA = {
  instagram: [
    {
      id: "pin-posts", name: "Pin Posts", title: "سنجاق کردن پست‌ها — افغان فالورز",
      hook: { l1: "بهترین پست‌هایت را", l2: "بالای پیج نگه دار" },
      ...
      steps: [
        ...
        { icon: "target", text: "منوی سه‌نقطه را باز کن", ui: { screen: "list", title: "گزینه‌ها", rows: ["سنجاق به پروفایل", "آرشیو"], hit: 0 } },
    ...
    {
      id: "close-friends", name: "Close Friends", title: "دوستان نزدیک — افغان فالورز",
      hook: { l1: "برای مخاطب وفادارت", l2: "محتوای ویژه بگذار" },
      payoff: "حس عضویت خاص می‌سازد و مخاطب را نزدیک‌تر نگه می‌دارد.",
      steps: [
        { icon: "user", text: "به تنظیمات پیج برو", ui: { screen: "list", title: "تنظیمات", rows: ["دوستان نزدیک", "حریم خصوصی"], hit: 0 } },
    ...
    {
      id: "add-yours", name: "Add Yours", title: "استیکر Add Yours — افغان فالورز",
      hook: { l1: "یک زنجیرهٔ استوری", l2: "راه بینداز" },
      payoff: "هر کسی که شرکت کند، پیج تو را به مخاطبانش نشان می‌دهد.",
      steps: [
        { icon: "camera", text: "یک استوری بساز", ui: { screen: "compose", title: "استوری", cta: "افزودن استیکر" } },
        { icon: "sparkle", text: "استیکر «Add Yours» را انتخاب کن", ui: { screen: "list", title: "استیکرها", rows: ["Add Yours", "نظرسنجی", "سؤال"], hit: 0 } },
        { icon: "pen", text: "یک موضوع جذاب بنویس", ui: { screen: "compose", title: "موضوع", cta: "انتشار" } },
        { icon: "users", text: "دیگران استوری خودشان را اضافه می‌کنند", ui: { screen: "result", title: "زنجیره شروع شد" } },
      ],
      tgTitle: "🔗 با Add Yours یک زنجیرهٔ استوری راه بینداز\n\n#اینستاگرام #استوری #افغان_فالورز",
    },
  ],
  tiktok: [
    {
      id: "playlists", name: "Playlists", title: "پلی‌لیست تیک‌تاک — افغان فالورز",
      hook: { l1: "کاری کن بیننده", l2: "پشت‌سرهم تماشا کند" },
      payoff: "بیننده به‌جای یک ویدیو، چند ویدیو را پشت‌سرهم می‌بیند.",
      steps: [
        { icon: "layers", text: "به پروفایلت برو", ui: { screen: "list", title: "پروفایل", rows: ["مدیریت پلی‌لیست", "تنظیمات"], hit: 0 } },
      ...
      tgTitle: "📚 با پلی‌لیست، بیننده را نگه دار\n\n#تیک_تاک #زمان_تماشا #افغان_فالورز",
    },
    {
      id: "green-screen", name: "Green Screen", title: "افکت پرده سبز — افغان فالورز",
      hook: { l1: "عکس یا صفحه را", l2: "پشت خودت بگذار" },
      ...
      steps: [
        ...
        { icon: "wand", text: "در افکت‌ها «Green Screen» را انتخاب کن", ui: { screen: "list", title: "افکت‌ها", rows: ["پرده سبز", "زمان", "زیبایی"], hit: 0 } },
    ...
    {
      id: "tts-voice", name: "Text to Speech", title: "تبدیل متن به صدا — افغان فالورز",
      hook: { l1: "بدون ضبط صدا", l2: "روایت بساز" },
      ...
      tgTitle: "🔊 بدون ضبط صدا، روایت بساز\n\n#تیک_تاک #ترفند #افغان_فالورز",
    },
  ],
  tools: [
    {
      id: "canva-cover", name: "Canva", title: "طراحی کاور با Canva — افغان فالورز",
      hook: { l1: "کاور حرفه‌ای", l2: "بدون طراح" },
      payoff: "کاور یکدست، پیج را در یک نگاه حرفه‌ای نشان می‌دهد.",
      steps: [
        { icon: "globe", text: "سایت کانوا را باز کن", ui: { screen: "tool", url: "canva.com", cta: "شروع رایگان" } },
    ...
    {
      id: "ideogram-text", name: "Ideogram", title: "تصویر با متن خوانا — افغان فالورز",
      hook: { l1: "تصویری بساز", l2: "که متنش خوانا باشد" },
      ...
      tgTitle: "🖼️ تصویری بساز که متنش خوانا باشد\n\n#هوش_مصنوعی #طراحی #افغان_فالورز",
    },
    {
      id: "meta-schedule", name: "Meta Business Suite", title: "زمان‌بندی پست‌ها — افغان فالورز",
      hook: { l1: "پست‌های یک هفته را", l2: "یک‌جا آماده کن" },
      payoff: "نظم در انتشار، بدون اینکه هر روز درگیر باشی.",
      steps: [
        { icon: "globe", text: "متا بیزنس سویت را باز کن", ui: { screen: "tool", url: "business.facebook.com", cta: "ورود" } },
