...
export const EXTRA = {
  instagram: [
    ...
    },
    {
      ...
      hook: { ask: "با این استیکر اینستاگرام، فالوورهایت را وارد ترند خودت کن و وایرال شو", l1: "یک زنجیرهٔ استوری", l2: "راه بینداز" },
  ...
  tiktok: [
    {
      ...
      tgTitle: "📚 با پلی‌لیست، بیننده را نگه دار\n\n#tiktok #retention #AfghanFollowers #viral",
    },
    {
      id: "green-screen",
      ...
      tgTitle: "🟢 با پرده سبز، روی تصویر توضیح بده\n\n#tiktok #contentcreator #AfghanFollowers #viral",
    },
    {
      id: "tts-voice",
      ...
      tgTitle: "🔊 بدون ضبط صدا، روایت بساز\n\n#tiktok #tips #AfghanFollowers #viral",
    },
  ],
  tools: [
    {
      ...
      hook: { ask: "کاملاً رایگان: کاوری بساز که کلیک بگیرد", l1: "کاور حرفه‌ای", l2: "بدون طراح" },
      ...
      tgTitle: "🎨 کاور حرفه‌ای بدون طراح، با Canva\n\n#freeapp #design #AfghanFollowers #viral",
    },
    {
      id: "ideogram-text",
      benefit: { key: "seen", fa: "متن خوانا روی تصویر یعنی پیامت گم نمی‌شود" },
      hook: { ask: "این اپ رایگان است — کاور و پوستر بساز بدون اینکه دیزاینر باشی", l1: "تصویری بساز", l2: "که متنش خوانا باشد" },
      ...
      tgTitle: "🖼️ تصویری بساز که متنش خوانا باشد\n\n#ai #design #AfghanFollowers #viral",
    },
    {
      id: "meta-schedule",
      benefit: { key: "seen", fa: "سر ساعت اوج پست کن، حتی وقتی سرت شلوغ است" },
      hook: { ask: "رایگان است — یک شب کار کن و تمام هفته پست داشته باش", l1: "پست‌ها را زمان‌بندی کن", l2: "خودش منتشر می‌کند" },
