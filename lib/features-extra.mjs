  ...
  instagram: [
    ...
    },
    {
      ...
      steps: [
        ...
        { screen: {"title":"Stickers","rows":["Add Yours","Poll","Questions"],"hit":0}, icon: "sparkle", text: "استیکر «Add Yours» را انتخاب کن", ui: { screen: "list", title: "استیکرها", rows: ["Add Yours", "نظرسنجی", "سؤال"], hit: 0 } },
