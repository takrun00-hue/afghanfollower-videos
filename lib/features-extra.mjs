...
export const EXTRA = {
  instagram: [
    ...
    },
    {
      ...
      hook: { ask: "با این قابلیت رایگان اینستاگرام، از مخاطبت مشتری همیشگی بساز", l1: "برای مخاطب وفادارت", l2: "محتوای ویژه بگذار" },
  ...
  tiktok: [
    ...
    },
    {
      ...
      hook: { ask: "با این قابلیت رایگان تیک‌تاک، ویدیوی توضیحی حرفه‌ای بساز", l1: "عکس یا صفحه را", l2: "پشت خودت بگذار" },
    ...
    },
    {
      ...
      hook: { ask: "با این قابلیت رایگان تیک‌تاک، بدون اینکه حرف بزنی ویدیوی گویا بساز", l1: "بدون ضبط صدا", l2: "روایت بساز" },
  ...
  tools: [
    ...
    },
    {
      ...
      hook: { ask: "با این اپ رایگان، کاور و پوستر بساز بدون اینکه طراح باشی", l1: "تصویری بساز", l2: "که متنش خوانا باشد" },
    ...
    },
    {
      ...
      hook: { ask: "با این اپ رایگان، یک شب کار کن و تمام هفته پست داشته باش", l1: "پست‌ها را زمان‌بندی کن", l2: "خودش منتشر می‌کند" },
