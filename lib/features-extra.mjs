...
export const EXTRA = {
  ...
  tiktok: [
    ...
    },
    {
      ...
      tgTitle: "🟢 با پرده سبز، روی تصویر توضیح بده\n\n#tiktok #contentcreator #افغان_فالورز #viral",
    },
    {
      id: "tts-voice",
