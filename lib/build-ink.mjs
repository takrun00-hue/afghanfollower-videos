...
.stepnum{position:absolute;top:-30px;left:-34px;z-index:2;width:118px;height:118px;border-radius:50%;
...
tl.to("#s1 .hookq",{scale:1.05,duration:.14,ease:"power2.out"},1.15)
  .to("#s1 .hookq",{scale:1,duration:.4,ease:"elastic.out(1,.6)"},1.29);
