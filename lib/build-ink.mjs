...
export function buildInkHTML(pack) {
  ...
  const sceneStep = (i, tip, ink) => `
      <div class="stepwrap">
        ...
        ${tip.photo
          ? `<div class="official-ui focus-${tip.photoFocus || "default"}"><img src="${photoSrc(tip.photo)}" alt="TikTok Creator Search Insights"/><span class="focusframe"></span><span class="tapdot"></span></div>`
          : pack.photos?.[i]
...
.hookphoto{width:430px;height:540px;transform:rotate(-3deg)}
.hookphoto img{object-fit:cover;object-position:31% 50%}
...
.official-ui{position:relative;width:470px;height:720px;overflow:hidden;border-radius:52px;background:#bcd8ff;border:7px solid #fff;box-shadow:0 34px 76px rgba(18,28,46,.32)}
.official-ui img{position:absolute;top:0;left:-238px;width:1280px;height:auto;max-width:none;display:block}.official-ui.focus-search img,.official-ui.focus-gap img{left:-238px}.official-ui.focus-analytics img{left:-580px}
.official-ui .focusframe{position:absolute;border:6px solid #ff315f;border-radius:20px;box-shadow:0 0 0 12px rgba(255,49,95,.18),0 0 34px rgba(255,49,95,.45)}
.official-ui .tapdot{position:absolute;width:48px;height:48px;border:5px solid #fff;border-radius:50%;background:#ff315f;box-shadow:0 9px 22px rgba(20,24,36,.3)}
.official-ui.focus-search .focusframe{left:94px;top:62px;width:238px;height:58px}.official-ui.focus-search .tapdot{left:304px;top:99px}
.official-ui.focus-gap .focusframe{left:112px;top:422px;width:190px;height:56px}.official-ui.focus-gap .tapdot{left:273px;top:452px}
.official-ui.focus-analytics .focusframe{left:102px;top:196px;width:206px;height:126px}.official-ui.focus-analytics .tapdot{left:279px;top:286px}
      ...
      <div class="hookpreview">
        ${pack.platform === "news" && (pack.hookPhoto || pack.photos?.[0])
          ...
          : pack.platform !== "news" && pack.hookPhoto
            ? `<div class="newsphoto tutorialphoto hookphoto"><img src="${photoSrc(pack.hookPhoto)}" alt="TikTok Creator Search Insights"/></div>`
          : HOOK_BRAND
            ? toolCard(HOOK_BRAND)
            : HOOK_SCREEN
...
tl.fromTo("#s1 .hookpreview .tutorialphoto",{y:90,scale:.72,rotation:-12,opacity:0},{y:0,scale:1,rotation:-3,opacity:1,duration:.62,ease:"back.out(1.7)"},.26);
}
