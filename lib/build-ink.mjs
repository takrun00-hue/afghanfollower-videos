...
.hookphoto{width:330px;height:540px;transform:rotate(-3deg)}
...
.official-ui{position:relative;width:400px;height:720px;overflow:hidden;border-radius:52px;background:#bcd8ff;border:7px solid #fff;box-shadow:0 34px 76px rgba(18,28,46,.32)}
