...
.paper{position:absolute;inset:0;z-index:0;
  background:
    ...
    linear-gradient(180deg,${PAPER_NEAR} 0%,${PAPER} 38%,${PAPER_FAR} 100%)}
...
.scene:has(.official-ui) .paper{
  background:${paperIsDark ? `
    radial-gradient(circle at 50% 36%, #14181f, transparent 56%),
    radial-gradient(120% 88% at 86% 2%, rgba(80,120,140,.28), transparent 58%),
    radial-gradient(100% 70% at 6% 100%, rgba(60,100,120,.24), transparent 60%),
    linear-gradient(176deg,#05070a 0%,${PAPER} 48%,#000000 100%)` : `
  ...
  background-image:linear-gradient(${paperIsDark ? "rgba(160,190,200,.09)" : "rgba(150,110,70,.09)"} 1px,transparent 1px),
    linear-gradient(90deg,${paperIsDark ? "rgba(160,190,200,.09)" : "rgba(150,110,70,.09)"} 1px,transparent 1px);
