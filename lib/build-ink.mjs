...
export function buildInkHTML(pack) {
  ...
  const sceneStep = (i, tip, ink) => `
      <div class="stepwrap">
        ...
        ${pack.platform === "news" && pack.photos?.[1] && i === 1
          ? `<div class="newsphoto"><img src="${pack.photos[1].dataURI}" alt=""/><span>تصویر آرشیوی</span></div>`
  ...
  <section id="s1" class="clip hookscene" data-start="0" data-duration="${HOOK}" data-track-index="1">
    ...
    <div class="world hookworld" id="w1">
      ...
      <div class="hookpreview">
        ${pack.platform === "news" && pack.photos?.[0]
          ? `<div class="newsphoto hookphoto"><img src="${pack.photos[0].dataURI}" alt=""/><span>تصویر آرشیوی</span></div>`
          : HOOK_BRAND
          ? toolCard(HOOK_BRAND)
          : HOOK_SCREEN
