...
// Trusted sources, in the languages the audience reads. Anything outside this
// list is not used unless a second source confirms it.
export const SOURCES = {
  "dw-fa": { name: "DW فارسی/دری", domain: "dw.com" },
  amal: { name: "Amal Berlin", domain: "amalberlin.de" },
  handbook: { name: "Handbook Germany", domain: "handbookgermany.de" },
  bbc: { name: "BBC فارسی", domain: "bbc.com" },
