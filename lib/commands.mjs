...
export const COMMANDS = [
  ...
  },
  {
    ...
    test: (c) => ANY(c, "موضوع فردا", "برنامه فردا", "فردا") && !ANY(c, "خبر"),
  },
  {
    action: "plan-tiktok",
...
export const HELP_TEXT =
  ...
  "• <b>موضوع فردا</b> / <b>برنامه هفته</b> — فقط پیشنهادهای تحقیق‌شده\n" +
  "• <b>تیک‌تاک</b> / <b>انستا</b> / <b>ابزار</b> — موضوع‌های همان بخش\n" +
  "• <b>تأیید trial-reels</b> — فقط همان موضوع را بساز\n" +
