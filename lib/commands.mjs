...
export const COMMANDS = [
  ...
  {
    // «اروپا ۲» — build item N from the Europe list
    action: "europe-pick",
  ...
  {
    // «خبر ۲» — build from item N of the just-shown Germany list
    action: "news-pick",
  ...
  },
  {
    ...
    test: (c) => (c.includes("پاک کن") || c.includes("حذف کن")) && (c.includes("خبر") || c.includes("news")),
  },
  {
    action: "undo",
