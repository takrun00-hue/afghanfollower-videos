...
export const GERMAN_A1 = [
  ...
  },
  {
    ...
    items: [
      { de: "ich habe", fa: "من دارم", img: "person holding coffee cup", example: "Ich habe Zeit. — من وقت دارم." },
      { de: "du hast", fa: "تو داری", img: "person holding phone smiling", example: "Hast du ein Auto? — ماشین داری؟" },
      { de: "er/sie hat", fa: "او دارد", img: "person holding book reading", example: "Sie hat ein Buch. — او یک کتاب دارد." },
      { de: "wir haben", fa: "ما داریم", img: "family sitting together at table", example: "Wir haben Hunger. — ما گرسنه‌ایم." },
    ],
  },
  {
    id: "a1-13-food-drink",
    topic: "غذا و نوشیدنی",
    hook: "اولین سفارشت در آلمان را همین حالا یاد بگیر.",
    items: [
  ...
  },
  {
    ...
    hook: "با این ۴ صفت، هر چیزی را توصیف کن.",
    items: [
