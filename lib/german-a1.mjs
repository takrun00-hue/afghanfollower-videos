...
export const GERMAN_A1 = [
  ...
  },
  {
    ...
    //
    // Rewritten again same day: the first replacement ended in "...توصیف
    // کن." — "توصیف" was independently flagged by Narration QC twice, and
    // ending the sentence on a short, low-context word turned out to be
    // fragile for TTS/ASR round-tripping in general (see lib/narration.mjs's
    // a1-17 entry for the "بد" case that actually blocked this episode's
    // build). This version drops "توصیف" and keeps "بد" mid-sentence,
    // followed by five more words, instead of sentence-final.
