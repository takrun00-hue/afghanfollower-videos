...
export const BRAND_LOGOS = {
  ...
  // Abstracted, not traced from the real marks — a circle-ring and a burst,
  // in each brand's known public colour, the same convention as every entry
  // above (Descript's ring, Suno's waveform): recognisable, not a copy.
  ChatGPT: {
    bg: "#10A37F",
    svg: `<circle cx="76" cy="76" r="30" fill="none" stroke="#fff" stroke-width="11"/>
      <circle cx="76" cy="46" r="8" fill="#fff"/><circle cx="102" cy="90" r="8" fill="#fff"/><circle cx="50" cy="90" r="8" fill="#fff"/>`,
  },
  Claude: {
    bg: "#D97757",
    svg: `<path d="M76 30v92M32 76h88M48 44l56 64M104 44l-56 64" stroke="#fff" stroke-width="9" stroke-linecap="round"/>`,
  },
  Gemini: {
    bg: "#1a1a2e",
    svg: `<path d="M76 24c4 34 18 48 52 52-34 4-48 18-52 52-4-34-18-48-52-52 34-4 48-18 52-52z" fill="#4285F4"/>`,
  },
};
