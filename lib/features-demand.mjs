  ...
  tiktok: [
    {
      ...
      hook: { ask: "آیا می‌دانید چرا ویدیوهایت روی ۲۰۰ ویو گیر می‌کند و دیده نمی‌شود؟", l1: "چرا تیک‌تاک جلوترش نمی‌برد", l2: "سه ثانیهٔ اول را عوض کن" },
    ...
    },
    {
      ...
      hook: { ask: "آیا می‌دانید با چند هزار ویو در تیک‌تاک می‌شود درآمد گرفت؟", l1: "عدد واقعی", l2: "و چطور به آن برسی" },
  ...
  instagram: [
    {
      ...
      hook: { ask: "آیا می‌دانید هشتگ‌ها بازدید پستت را کم می‌کنند؟", l1: "۳۱٪ بازدید کمتر", l2: "با هشتگ نسبت به بدون آن" },
    ...
    },
    {
      ...
      hook: { ask: "آیا می‌دانید یک جمله در کپشن، لایک و دیده‌شدنت را کم می‌کند؟", l1: "لایکت ۶۰٪ کم می‌شود", l2: "این را بگو به‌جایش" },
  ...
  tools: [
    {
      ...
      hook: { ask: "آیا می‌دانید سه ثانیهٔ اول چقدر از بازدیدت را می‌خورد؟", l1: "بررسی ۴۸۹۳ ویدیو:", l2: "قلاب ۱۷ برابر تعیین‌کننده است" },
    ...
    },
    {
      ...
      hook: { ask: "آیا می‌دانید یک‌سوم بازدیدت را به‌خاطر نبودن زیرنویس از دست می‌دهی؟", l1: "۳۰ درصد مردم", l2: "ویدیو را بی‌صدا می‌بینند" },
