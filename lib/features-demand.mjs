  ...
  tools: [
    {
      ...
      hook: { ask: "آیا می‌دانید سه ثانیهٔ اول چقدر از بازدیدت را می‌خورد؟", l1: "بررسی ۴۸۹۳ ویدیو", l2: "سه ثانیهٔ اول را درست کن" },
    ...
    },
    {
      ...
      hook: { ask: "آیا می‌دانید یک‌سوم بازدیدت را به‌خاطر نبودن زیرنویس از دست می‌دهی؟", l1: "بدون زیرنویس", l2: "آن‌ها را از دست می‌دهی" },
