  ...
  tiktok: [
    {
      ...
      hook: { ask: "ویدیوهایت روی ۲۰۰ ویو گیر می‌کند؟", l1: "چرا تیک‌تاک جلوترش نمی‌برد", l2: "سه ثانیهٔ اول را عوض کن" },
    ...
    },
    {
      ...
      hook: { ask: "آیا می‌دانید تیک‌تاک برای هر هزار ویو چقدر می‌دهد؟", l1: "عدد واقعی", l2: "و چطور به آن برسی" },
  ...
  instagram: [
    {
      ...
      hook: { ask: "آیا می‌دانید هشتگ‌ها بازدید را کم می‌کنند؟", l1: "۳۱٪ بازدید کمتر", l2: "با هشتگ نسبت به بدون آن" },
    ...
    },
    {
      ...
      hook: { ask: "آیا می‌دانید چرا نباید بگویی «لایک کنید»؟", l1: "لایکت ۶۰٪ کم می‌شود", l2: "این را بگو به‌جایش" },
  ...
  tools: [
    {
      ...
      hook: { ask: "آیا می‌دانید قلاب ضعیف چقدر بازدید می‌خورد؟", l1: "بررسی ۴۸۹۳ ویدیو", l2: "سه ثانیهٔ اول را درست کن" },
    ...
    },
    {
      ...
      hook: { ask: "آیا می‌دانید چند درصد مردم ویدیو را بی‌صدا می‌بینند؟", l1: "بدون زیرنویس", l2: "آن‌ها را از دست می‌دهی" },
