  ...
  tiktok: [
    {
      id: "view-jail",
      name: "200 Views",
      benefit: { key: "seen", fa: "از ۲۰۰ ویو بیرون بیا؛ مشکل الگوریتم نیست" },
    ...
    },
    {
      ...
      benefit: { key: "money", fa: "بفهم تیک‌تاک بابت هزار ویو چقدر می‌دهد" },
  ...
  instagram: [
    {
      ...
      benefit: { key: "seen", fa: "هشتگ‌ها الان ویو می‌خورند؛ کلمهٔ کلیدی جایشان را گرفته" },
    ...
    },
    {
      id: "ask-dont-beg",
      name: "Comments 26%",
      benefit: { key: "viral", fa: "درخواست لایک، لایک را ۶۰٪ کم می‌کند" },
  ...
  tools: [
    {
      id: "hook-17x",
      name: "Hook = 17x",
      benefit: { key: "viral", fa: "قلاب خراب ۱۷ برابر بازدید می‌خورد" },
    ...
    },
    {
      id: "mute-30",
      name: "Captions",
      benefit: { key: "seen", fa: "یک‌سوم مردم بی‌صدا می‌بینند؛ بدون زیرنویس آن‌ها را از دست می‌دهی" },
