  ...
  tiktok: [
    {
      ...
      steps: [
        ...
        // The real TikTok Video analysis screen, with the real retention curve.
        // It is also what the hook shows: build-ink takes the first step photo
        // for the hook, so the video opens on a real screen rather than a
        // reconstruction of one.
        { path: "Watch time", icon: "clock", text: "زمان تماشا و افت مخاطب را در آمار ببین",
          photo: "public/sources/tiktok-comment-analytics-real.webp",
          photoAlt: "TikTok Video analysis — retention",
