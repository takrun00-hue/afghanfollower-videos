  ...
  tiktok: [
    {
      id: "view-jail",
      name: "200 Views",
      benefit: { key: "seen", fa: "آیا می‌دانید چرا ویدیوها روی ۲۰۰ ویو گیر می‌کنند؟" },
      title: "چرا ویدیو در ۲۰۰ ویو گیر می‌کند — افغان فالورز",
      hook: { ask: "ویدیوت روی ۲۰۰ ویو گیر کرده؟", l1: "چرا تیک‌تاک جلوترش نمی‌برد", l2: "سه ثانیهٔ اول را عوض کن" },
      ...
      tgTitle: "🚧 چرا ویدیوت روی ۲۰۰ ویو گیر کرده؟ (جواب واقعی، نه شایعه)\n\n#تیک_تاک #ویو #رشد_پیج #افغان_فالورز",
    },
    {
      id: "tiktok-pay",
      name: "Creator Rewards",
      benefit: { key: "money", fa: "آیا می‌دانید تیک‌تاک برای هر هزار ویو چقدر می‌دهد؟" },
      title: "تیک‌تاک چقدر پول می‌دهد — افغان فالورز",
      hook: { ask: "تیک‌تاک بابت هزار ویو چقدر می‌دهد؟", l1: "عدد واقعی", l2: "و چطور به آن برسی" },
  ...
  instagram: [
    {
      ...
      benefit: { key: "seen", fa: "آیا می‌دانید هشتگ‌ها حالا بازدید را کم می‌کنند؟" },
      title: "هشتگ در اینستاگرام دیگر کار نمی‌کند — افغان فالورز",
      hook: { ask: "هشتگ‌هایت دارند ویو می‌خورند", l1: "۳۱٪ بازدید کمتر", l2: "با هشتگ نسبت به بدون آن" },
      ...
      tgTitle: "⚠️ هشتگ در اینستاگرام حالا ویو می‌خورد — چه بگذاریم؟\n\n#اینستاگرام #سئو #رشد_پیج #افغان_فالورز",
    },
    {
      id: "ask-dont-beg",
      name: "Comments 26%",
      benefit: { key: "viral", fa: "آیا می‌دانید درخواست لایک، لایک را کم می‌کند؟" },
      title: "چه چیزی از مخاطب بخواهیم — افغان فالورز",
      hook: { ask: "«لایک کنید» نگو", l1: "لایکت ۶۰٪ کم می‌شود", l2: "این را بگو به‌جایش" },
  ...
  tools: [
    {
      id: "hook-17x",
      name: "Hook = 17x",
      benefit: { key: "viral", fa: "آیا می‌دانید قلاب ضعیف چقدر بازدید می‌خورد؟" },
      title: "قلاب ضعیف چقدر ویو می‌خورد — افغان فالورز",
      hook: { ask: "قلاب خراب ۱۷ برابر ویو می‌خورد", l1: "بررسی ۴۸۹۳ ویدیو", l2: "سه ثانیهٔ اول را درست کن" },
      ...
      tgTitle: "🪝 قلاب ضعیف ۱۷ برابر ویو می‌خورد — بررسی ۴۸۹۳ ویدیو\n\n#تولید_محتوا #وایرال #افغان_فالورز",
    },
    {
      id: "mute-30",
      name: "Captions",
      benefit: { key: "seen", fa: "آیا می‌دانید چند درصد مردم ویدیو را بی‌صدا می‌بینند؟" },
      title: "بیش از ۳۰٪ بی‌صدا می‌بینند — افغان فالورز",
      hook: { ask: "یک‌سوم بیننده‌هایت صدا را نمی‌شنوند", l1: "بدون زیرنویس", l2: "آن‌ها را از دست می‌دهی" },
