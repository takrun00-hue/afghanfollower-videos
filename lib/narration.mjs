...
const VO = {
  ...
  "a1-02-introduce": {
    ...
    steps: [
      "برای گفتن اسمت، این جمله را با اسم خودت کامل کن.",
      "این سؤال را از طرف مقابل می‌پرسی تا اسمش را بگوید.",
      "برای گفتن اهلیتت، این جمله را با نام کشورت کامل کن.",
      "این سؤال را می‌پرسی تا بفهمی طرف مقابل اهل کجاست.",
    ],
    outro: "حالا می‌توانی خودت را کامل به آلمانی معرفی کنی.",
  },
  "a1-03-politeness": {
